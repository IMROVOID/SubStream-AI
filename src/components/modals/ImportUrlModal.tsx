...
import { Link, Youtube, Download, AlertCircle, Loader2, FileText, Film, ArrowLeft, Search, SortDesc, Globe, Lock, EyeOff, Check, Clipboard } from 'lucide-react';
...
import { VideoUrlThumbnail } from './ImportUrlModal/UrlThumbnail';
