...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({ 
  ...
  // Current active subtitle cue (defaults to first cue if video is at start)
  ...
  return (
    ...
    >
      {isResolving && (
        <div className="w-full h-full bg-neutral-950 flex flex-col items-center justify-center gap-3 text-neutral-400">
      ...
      {!isResolving && resolveError && (
        <div className="w-full h-full bg-neutral-950 flex flex-col items-center justify-center gap-3 text-neutral-400 px-6 text-center">
      ...
      {!isResolving && !resolveError && resolvedSrc && (
        <>
          ...
          {/* Subtitle SoftSub Cue Overlay (with Vazirmatn Persian Font Support & Custom Styles) */}
          {activeCue && (
            <div 
          ...
          >
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              {/* Rounded Vector Play / Pause Button */}
              <button 
                onClick={togglePlay} 
              ...
              {/* Mute & Clean Line + Circle Volume Slider */}
            ...
            <div className="flex-1 relative flex items-center group/timeline mx-1 h-3">
              ...
              {/* Single Circle Knob: Hidden when not hovering timeline */}
              <div 
